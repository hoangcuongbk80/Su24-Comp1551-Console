...
namespace WindowsFormsApp3 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(int Id, string Name, int Salary, string Role, System.DateTime Date) {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ([Name] = @Original" +
                "_Name) AND ([Salary] = @Original_Salary) AND ([Role] = @Original_Role) AND ([Dat" +
                "e] = @Original_Date))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Id] = @Id, [Name] = @Name, [Salary] = @Salary, [Role] = @Role, [Date] = @Date WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Salary] = @Original_Salary) AND ([Role] = @Original_Role) AND ([Date] = @Original_Date));
SELECT Id, Name, Salary, Role, Date FROM Employee WHERE (Id = @Id)";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Salary, string Original_Role, System.DateTime Original_Date) {
        ...
        public virtual int Insert(int Id, string Name, int Salary, string Role, System.DateTime Date) {
        ...
        public virtual int Update(int Id, string Name, int Salary, string Role, System.DateTime Date, int Original_Id, string Original_Name, int Original_Salary, string Original_Role, System.DateTime Original_Date) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Salary, string Role, System.DateTime Date, int Original_Id, string Original_Name, int Original_Salary, string Original_Role, System.DateTime Original_Date) {
